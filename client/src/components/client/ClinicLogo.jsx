...
const ClinicLogo = ({ size = 'md', className = '' }) => {
  ...
  return (
    <div className={`flex items-center gap-3 select-none ${className}`}>
      ...
      >
        ...
        <rect x="48.5" y="38" width="3" height="10" fill="#ffffff" rx="1" />
        <rect x="45" y="41.5" width="10" height="3" fill="#ffffff" rx="1" />
      ...
      <div className="flex flex-col leading-none">
        <span className={`font-['Playfair_Display'] font-extrabold tracking-tight text-[#cc3b38] ${isLarge ? 'text-[28px]' : 'text-[22px]'}`}>
          Sharnam
        </span>
        <span className={`font-['Inter'] font-semibold tracking-wide text-[#2c7a94] ${isLarge ? 'text-[18px] -mt-1' : 'text-[14px] -mt-0.5'}`}>
          Clinic
        </span>
      </div>
    </div>
